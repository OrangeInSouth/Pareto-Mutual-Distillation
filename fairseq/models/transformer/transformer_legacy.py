...
class TransformerModel(TransformerModelBase):
    ...
    def build_model(cls, args, task):
        ...
        cfg = TransformerConfig.from_namespace(args)
        # Modified by Eachan: I have to do this strange operation to pass the lang_pairs and lang2id through
        cfg.lang_pairs = getattr(args, "lang_pairs", None)
...
@register_model_architecture("transformer", "transformer_large_decoder")
def transformer_xl(args):

    args.decoder_embed_dim = 2048
