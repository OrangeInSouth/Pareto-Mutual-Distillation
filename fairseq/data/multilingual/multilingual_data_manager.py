...
class MultilingualDatasetManager(object):
    def __init__(self, args, lang_pairs, langs, dicts, sampling_method, pure_batch=False):
        super().__init__()
    ...
    @classmethod
    def setup_data_manager(cls, args, lang_pairs, langs, dicts, sampling_method, pure_batch=False):
        return MultilingualDatasetManager(
            args, lang_pairs, langs, dicts, sampling_method, pure_batch=pure_batch
        )
    ...
    def load_into_concat_dataset(self, split, datasets, data_param_list, pure_batch=False):
        ...
        return ConcatDataset([d for _, d in datasets], pure_batch=pure_batch, lang_pair_names=[k for k, _ in datasets])
