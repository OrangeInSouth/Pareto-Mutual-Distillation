...
class EpochBatchIterator(EpochBatchIterating):
    ...
    def __init__(
        ...
        self.dataset = dataset  # fairseq.data.multilingual.sampled_multi_dataset.SampledMultiDataset
        self.collate_fn = collate_fn
    ...
    def frozen_batches(self):
        if self._frozen_batches is None:  # when first calling this function, _frozen_batches is None
    ...
    def _get_iterator_for_epoch(
        ...
        if self._supports_prefetch:  # False
            ...
            if shuffle:  # True
                # self.frozen_batches:
                #  list of batches (len is iteration numbers),
                #  batch of which is a list of sample indices.
