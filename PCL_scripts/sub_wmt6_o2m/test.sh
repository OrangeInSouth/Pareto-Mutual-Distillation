...
#bash ${project_path}/PCL_scripts/sub_wmt6_o2m/post_test_zh.sh ${OUTPUT_DIR}/test_en_zh.txt >> ${OUTPUT_DIR}/test_en_zh.txt
#
${python_path} ${project_path}/PCL_scripts/sub_wmt6_o2m/result_statistics.py $OUTPUT_DIR > ${OUTPUT_DIR}/result.txt 2>&1
